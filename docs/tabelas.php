        ...
        <div class='container px-5'>
            ...
            <div class='collapse navbar-collapse' id='navbarSupportedContent'>
                <ul class='navbar-nav ms-auto mb-2 mb-lg-0'>
                    ...
                    <li class='nav-item'><a class='nav-link' href='index.php'>Docs</a></li>
                    <li class='nav-item'><a class='nav-link' href='../index.php#servicos'>Serviços</a></li>
                    <li class='nav-item'><a class='nav-link' href='#!'><?php echo $_SESSION['usuario_logado']; ?></a></li>
                    <!-- Logout -->
